...
@Api(value = "Search")
public interface SearchReactiveApi {
  ...
  Mono<GetCharactersCharacterIdSearchOk> getCharactersCharacterIdSearch(
      @NotNull @Size(min = 1, max = 11) @ApiParam(value = "Type of entities to search for", required = true, allowableValues = "agent, alliance, character, constellation, corporation, faction, inventory_type, region, solar_system, station, structure") @Valid @RequestParam(value = "categories", required = true) Flux<String> categories,
  ...
  @RequestMapping(value = "/search/",
      ...
      consumes = "",
      method = RequestMethod.GET)
  Mono<GetSearchOk> getSearch(
      @NotNull @Size(min = 1, max = 10) @ApiParam(value = "Type of entities to search for", required = true, allowableValues = "agent, alliance, character, constellation, corporation, faction, inventory_type, region, solar_system, station") @Valid @RequestParam(value = "categories", required = true) Flux<String> categories,
      @NotNull @Size(min = 3) @ApiParam(value = "The string to search on", required = true) @Valid @RequestParam(value = "search", required = true) String search,
      @ApiParam(value = "Language to use in the response", allowableValues = "de, en-us, fr, ja, ru, zh", defaultValue = "en-us") @RequestHeader(value = "Accept-Language", required = false) String acceptLanguage,
      @ApiParam(value = "The server name you would like data from", allowableValues = "tranquility, singularity", defaultValue = "tranquility") @Valid @RequestParam(value = "datasource", required = false, defaultValue = "tranquility") String datasource,
      @ApiParam(value = "ETag from a previous request. A 304 will be returned if this matches the current ETag") @RequestHeader(value = "If-None-Match", required = false) String ifNoneMatch,
