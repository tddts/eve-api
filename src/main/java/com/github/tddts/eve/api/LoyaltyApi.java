...
public interface LoyaltyApi {
  ...
  List<GetCharactersCharacterIdLoyaltyPoints200Ok> getCharactersCharacterIdLoyaltyPoints(
  ...
  @RequestMapping(value = "/loyalty/stores/{corporation_id}/offers/",
      ...
      consumes = "",
      method = RequestMethod.GET)
  List<GetLoyaltyStoresCorporationIdOffers200Ok> getLoyaltyStoresCorporationIdOffers(
