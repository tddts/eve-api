...
public interface PlanetaryInteractionApi {
  ...
  List<GetCharactersCharacterIdPlanets200Ok> getCharactersCharacterIdPlanets(
  ...
  @RequestMapping(value = "/corporations/{corporation_id}/customs_offices/",
      ...
      consumes = "",
      method = RequestMethod.GET)
  List<GetCorporationsCorporationIdCustomsOffices200Ok> getCorporationsCorporationIdCustomsOffices(
