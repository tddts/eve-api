...
public interface RoutesApi {
  ...
  List<Integer> getRouteOriginDestination(@ApiParam(value = "destination solar system ID", required = true) @PathVariable("destination") Integer destination,
      @ApiParam(value = "origin solar system ID", required = true) @PathVariable("origin") Integer origin,
      @Size(max = 100) @ApiParam(value = "avoid solar system ID(s)") @Valid @RequestParam(value = "avoid", required = false) List<Integer> avoid,
      @Size(max = 100) @ApiParam(value = "connected solar system pairs") @Valid @RequestParam(value = "connections", required = false) List<List<Integer>> connections,
