...
public interface KillmailsApi {
  ...
  List<GetCharactersCharacterIdKillmailsRecent200Ok> getCharactersCharacterIdKillmailsRecent(
  ...
  @RequestMapping(value = "/corporations/{corporation_id}/killmails/recent/",
      ...
      consumes = "",
      method = RequestMethod.GET)
  List<GetCorporationsCorporationIdKillmailsRecent200Ok> getCorporationsCorporationIdKillmailsRecent(
